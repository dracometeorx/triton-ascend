// RUN: triton-opt %s --split-input-file --verify-each -graph-optimize='target-arch=Ascend910B1 rule-mask=512 ub-capacity-bytes=98304 compile-mode=simd' | FileCheck %s
